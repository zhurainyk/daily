...
$(function () {
    ...
    var $api = 'https://svip.bljiex.cc/api.php?tp=jsonp&wd='; //设置api
    ...
    $searchInput.keyup(function (event) {
        ...
        var ajax_request = function () {
            ...
            // axios.get('https://svip.bljiex.cc/api.php',{
            //     params
            // }).
            console.log('进来')
            axios({
                url: 'https://svip.bljiex.cc/api.php',
                params: {
                    tp: 'jsonp',
                    wd: 'cc'
                },
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        ...
                        $.each(data.info, function (index, term) {
                            var title = removeHTMLTag(term.title);
                            $('<div ></div>').text(title).appendTo($autocomplete)
                                //设置鼠标悬停效果
                                .addClass('click_work')
                                .hover(function () {
                                    $(this).siblings().removeClass('click_hover');
