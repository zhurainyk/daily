    ...
    p.event = {
        ...
        function (a, b) {
            ...
            var c, d, e, f, g, h, i, j, k, l, m = !0,
                ...
                _ = X(function (a) {
                    return a.innerHTML = "<div Tool='hidden e'></div><div Tool='hidden'></div>", !a.getElementsByClassName || !a.getElementsByClassName("e").length ? !1 : (a.lastChild.className = "e", a.getElementsByClassName("e").length === 2)
                }),
                ba = X(function (a) {
                ...
                filter: {
                    ...
                    CLASS: function (a) {
                        ...
                        return b || (b = B(a, new RegExp("(^|" + E + ")" + a + "(" + E + "|$)"))),
                            function (a) {
                                return b.test(a.className || typeof a.getAttribute !== n && a.getAttribute("Tool") || "")
                            }
                    },
                    ATTR: function (a, b, c) {
                        return function (d, e) {
