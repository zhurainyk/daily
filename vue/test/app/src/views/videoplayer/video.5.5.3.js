    ...
    return function b(a, c, d) {
                ...
                y = function () {
                    ...
                    return a.prototype.dispose = function () {
                        ...
                        if ("string" == typeof b) {
                            ...
                            if (!g) throw new Error("Component " + f + " does not exist");
            ...
            var h = a("./text-track-button.js"),
                ...
                x = (e(w), function (a) {
                    ...
                    return g(b, a), b.prototype.buildCSSClass = function () {
                        ...
                        var h = this.menu;
                        if (void 0 === h && (h = new q["default"](this.player_), h.contentEl().appendChild(s.createEl("li", {
        ...
        95: [function (a, b, c) {
            ...
            var h = a("../button.js"),
                ...
                m = a("../menu/menu.js"),
                n = e(m),
                o = a("../menu/menu-button.js"),
                p = e(o),
                q = a("./mute-toggle.js"),
                r = e(q),
                s = a("./volume-control/volume-bar.js"),
                t = e(s),
                u = a("global/document"),
                v = e(u),
                w = function (a) {
                    ...
                    return g(b, a), b.prototype.buildCSSClass = function () {
                        ...
                        return a.addChild(b), this.volumeBar = b, this.attachVolumeBarEvents(), a
                    }, b.prototype.handleClick = function () {
                        ...
                        this.on(["mousemove", "touchmove"], j.bind(this.volumeBar, this.volumeBar.handleMouseMove)), this.on(v["default"], ["mouseup", "touchend"], this.handleMouseUp)
                    }, b.prototype.handleMouseUp = function () {
                        this.off(["mousemove", "touchmove"], j.bind(this.volumeBar, this.volumeBar.handleMouseMove))
                    }, b
                }(p["default"]);
            w.prototype.volumeUpdate = r["default"].prototype.update, w.prototype.controlText_ = "Mute", l["default"].registerComponent("VolumeMenuButton", w), c["default"] = w, b.exports = c["default"]
        }, {
            "../button.js": 63,
            "../component.js": 65,
            "../menu/menu-button.js": 102,
        ...
        106: [function (a, b, c) {
            ...
            var h = a("./component.js"),
                ...
                ba = (e(aa), function (a) {
                    ...
                    return g(b, a), b.prototype.dispose = function () {
                        ...
                        }), c.playerId = c.id, c.id += "_html5_api", c.className = "vjs-tech", c.player = b.player = this, this.addClass("vjs-paused"), this.styleEl_ = D.createStyleElement("vjs-styles-dimensions");
                        ...
                        var e = c.split(":"),
                            f = e[1] / e[0];
                        a = void 0 !== this.width_ ? this.width_ : void 0 !== this.height_ ? this.height_ / f : this.videoWidth() || 300, b = void 0 !== this.height_ ? this.height_ : a * f, d = /^[^a-zA-Z]/.test(this.id()) ? "dimensions-" + this.id() : this.id() + "-dimensions", this.addClass(d), D.setTextContent(this.styleEl_, "\n      ." + d + " {\n        width: " + a + "px;\n        height: " + b + "px;\n      }\n\n      ." + d + ".vjs-fluid {\n        padding-top: " + 100 * f + "%;\n      }\n    ")
                    }, b.prototype.loadTech_ = function (a, b) {
                        this.tech_ && this.unloadTech_(), "Html5" !== a && this.tag && (_["default"].getTech("Html5").disposeMediaElement(this.tag), this.tag.player = null, this.tag = null), this.techName_ = a, this.isReady_ = !1;
                        var c = L["default"]({
                        ...
                        for (var b = void 0, c = 0, d = this.options_.techOrder; c < d.length; c++) {
                            var e = z["default"](d[c]),
                                f = _["default"].getTech(e);
                            if (f || (f = i["default"].getComponent(e)), f) {
                                if (f.isSupported() && (b = f.canPlayType(a))) return b
                            } else x["default"].error('The "' + e + '" tech is undefined. Skipped browser support check for that tech.')
                        }
                        return ""
                    }, b.prototype.selectSource = function (a) {
                        var b = this.options_.techOrder.map(z["default"]).map(function (a) {
                                return [a, _["default"].getTech(a) || i["default"].getComponent(a)]
                            }).filter(function (a) {
                                var b = a[0],
                                    c = a[1];
                                return c ? c.isSupported() : (x["default"].error('The "' + b + '" tech is undefined. Skipped browser support check for that tech.'), !1)
                            }),
                            c = function (a, b, c) {
                                var d = void 0;
                        ...
                        var b = _["default"].getTech(this.techName_);
                        ...
                        return this.loadTech_(z["default"](this.options_.techOrder[0]), null), this.techCall_("reset"), this
                        ...
                        return void 0 === a ? this.error_ || null : null === a ? (this.error_ = a, this.removeClass("vjs-error"), this.errorDisplay.close(), this) : (this.error_ = a instanceof H["default"] ? a : new H["default"](a), this.addClass("vjs-error"), x["default"].error("(CODE:" + this.error_.code + " " + H["default"].errorTypes[this.error_.code] + ")", this.error_.message, this.error_), this.trigger("error"), this)
            ...
            ba.prototype.options_ = {
                ...
                language: k["default"].getElementsByTagName("html")[0].getAttribute("lang") || ca.languages && ca.languages[0] || ca.userLanguage || ca.language || "en",
                languages: {},
                notSupportedMessage: "No compatible source was found for this video."
            }, ba.prototype.handleLoadedMetaData_, ba.prototype.handleLoadedData_, ba.prototype.handleUserActive_, ba.prototype.handleUserInactive_, ba.prototype.handleTimeUpdate_, ba.prototype.handleTechEnded_, ba.prototype.handleVolumeChange_, ba.prototype.handleError_, ba.prototype.flexNotSupported_ = function () {
            ...
            }, i["default"].registerComponent("Player", ba), c["default"] = ba, b.exports = c["default"]
        }, {
                ...
                F = function (a) {
                    ...
                    return g(b, a), b.prototype.manualProgressOn = function () {
                        ...
                        var a = this,
                            b = this.textTracks();
                        if (b) {
                            if (!C["default"].WebVTT && null != this.el().parentNode) {
                                var c = E["default"].createElement("script");
                                c.src = this.options_["vtt.js"] || "https://cdn.rawgit.com/gkatsev/vtt.js/vjs-v0.12.1/dist/vtt.min.js", this.el().parentNode.appendChild(c), C["default"].WebVTT = !0
                            }
                            var d = function () {
                                ...
                                e = function () {
                                    ...
                                    for (var a = 0; a < b.length; a++) {
                                        var c = b[a];
                                        c.removeEventListener("cuechange", d), "showing" === c.mode && c.addEventListener("cuechange", d)
                                    }
                                };
                            e(), b.addEventListener("change", e), this.on("dispose", function () {
            ...
            var f = a("../utils/browser.js"),
                ...
                j = function k(a) {
                    ...
                    if (g.IS_IE8) {
                        ...
                        for (var c in k.prototype) "constructor" !== c && (b[c] = k.prototype[c])
                    }
        ...
        122: [function (a, b, c) {
            ...
            var f = a("../event-target"),
                ...
                n = function p(a) {
                    ...
                    if (k.IS_IE8) {
                        ...
                        for (var c in p.prototype) "constructor" !== c && (b[c] = p.prototype[c])
                    }
            ...
            n.prototype.addTrack_ = function (a) {
                ...
                for (var b = void 0, c = 0, d = this.length; d > c; c++)
                    if (this[c] === a) {
                        b = this[c], this.tracks_.splice(c, 1);
                        break
                    } b && this.trigger({
                    type: "removetrack",
                    track: b
            ...
            var f = a("./text-track-cue-list"),
                ...
                A = function E() {
                    ...
                    if (m.IS_IE8) {
                        ...
                        for (var c in E.prototype) "constructor" !== c && (b[c] = E.prototype[c])
                    }
                    b.tech_ = a.tech;
                    var d = o.TextTrackMode[a.mode] || "disabled",
                        e = o.TextTrackKind[a.kind] || "subtitles",
                        f = a.label || "",
                        h = a.language || a.srclang || "",
                        j = a.id || "vjs_text_track_" + k.newGUID();
                    ("metadata" === e || "chapters" === e) && (d = "hidden"), b.cues_ = [], b.activeCues_ = [];
                    var l = new g["default"](b.cues_),
                        n = new g["default"](b.activeCues_),
                        p = !1,
                        q = i.bind(b, function () {
                    ...
                    return "disabled" !== d && b.tech_.on("timeupdate", q), Object.defineProperty(b, "kind", {
                        ...
                        get: function () {
                            ...
                            if (p = !1, b.length !== this.activeCues_.length) p = !0;
                            else
                                for (var c = 0; c < b.length; c++) - 1 === D.call(this.activeCues_, b[c]) && (p = !0);
            ...
            var B = function (a, b) {
                ...
                C = function (a, b) {
                    ...
                    d && (c.cors = d), z["default"](c, i.bind(this, function (a, c, d) {
                        return a ? q["default"].error(a, c) : (b.loaded_ = !0, void("function" != typeof w["default"].WebVTT ? w["default"].setTimeout(function () {
                            B(d, b)
                        }, 100) : B(d, b)))
                    }))
                },
        ...
        139: [function (b, c, d) {
            ...
            j.autoSetupTimeout(1, $), $.VERSION = "5.5.3", $.options = t["default"].prototype.options_, $.getPlayers = function () {
