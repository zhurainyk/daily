### vue项目的移动端适配解决方案
>>> 使用 yarn add -D postcss-px-to-viewport-8-plugin
+ 在项目根目录新建postcss.config.js
  ```js
    ...
    //postcss-px-to-viewport  同时解决web和h5的适配问题 
    module.exports = (webpack) => {
        const viewportWidth = webpack.webpackLoaderContext.resourcePath.includes("h5") ? 375 : 1920
        return {
            plugins:[
            ["postcss-url",{}],
