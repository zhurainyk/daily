  ...
  <div id="workplan">
    ...
    <div class="tableList">
      <div class="item header">
        <div class="tab">序号</div>
        <div class="tab">日期</div>
        <div class="tab">电梯位置</div>
        <div class="tab">任务类型</div>
      ...
      <el-scrollbar height="80%">
        <div class="item list" v-for="(item, index) in tableList" :key="index">
          ...
          <div class="tab" style="text-overflow:ellipsis;overflow:hidden;white-space:nowrap; direction: rtl;"
            :title="item.elevatorLocation">{{
              item.elevatorLocation
            }}</div>
          <div class="tab">{{ item.taskType }}</div>
