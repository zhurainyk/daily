<template>
    ...
    <eleinfodialog ref="eleinfo_ref" :emitKey="'_engineeringbi'"></eleinfodialog>
</template>
<script setup>
...
onMounted(() => {
    initSocket()
    $bus.on('alarm_engineering_toast', autoRun)
})

const emit = (data) => {
    $bus.emit('alarm_engineering', data)
}
...
$bus.on('toastState_engineeringbi', visible => {
