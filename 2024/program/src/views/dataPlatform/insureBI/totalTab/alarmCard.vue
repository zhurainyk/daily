<template>
    ...
    <eleinfodialog ref="eleinfo_ref" :emitKey="'_insurebi'"></eleinfodialog>
</template>
<script setup>
...
onMounted(() => {
    initSocket()
    $bus.on('alarm_insure_toast', autoRun)
})

const emit = (data) => {
    $bus.emit('alarm_insure', data)
}
...
$bus.on('toastState_insurebi', visible => {
