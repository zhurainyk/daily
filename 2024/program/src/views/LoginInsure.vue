<template>
  <div class="login-bg">
    <div class="login-head-title">
      <label>{{ $t('business.loginTitle') }}</label>
    ...
    <div class="body-right">
      ...
      <div class="login">
        <div>
          <div>
            <div class="login-head">{{ $t('business.loginHead') }}</div>
...
.login-bg {
  ...
  .body-right {
    ...
    .login {
      ...
      align-items: center;
      border-radius: 20px;
      box-shadow: 0 5px 15px 1px rgba(3, 0, 55, 0.1);
      > div {
        display: flex;
    ...
    .login-type {
      ...
      display: flex;
      justify-content: center;
      background-image: url('../public/images/login/insure-login.png');
