<template>
    <div class="page-list">
        <ListComponet :select-by-condition-api="CleanUpkeep_selectByConditionApi"
            :select-count-by-condition-api="CleanUpkeep_selectCountByConditionApi" :save-api="CleanUpkeep_saveApi"
            :delete-by-id-api="CleanUpkeep_deleteByIdApi" :select-by-id-api="CleanUpkeep_selectByIdApi"
            :update-by-id-api="CleanUpkeep_updateByIdApi" :model-data="modelData" :table-map="tableMap"
...
import {
    CleanUpkeep_selectByConditionApi,
    CleanUpkeep_selectCountByConditionApi, CleanUpkeep_selectByIdApi, CleanUpkeep_updateByIdApi, CleanUpkeep_saveApi, CleanUpkeep_deleteByIdApi
