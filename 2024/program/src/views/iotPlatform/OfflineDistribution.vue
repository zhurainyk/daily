<template>
    <div class="page-list">
        <ListComponet :select-by-condition-api="ionlineselectByConditionApi"
            :select-count-by-condition-api="ionlineselectCountByConditionApi" :model-data="modelData"
            ...
            :show-h-check-box-porp="true" :isInitApi="true" :isClearCheckBox="true" :showResetSearch="true"
            :showActionPorp="false" @detail-fn="detailLog" exportExcelName="电梯离线分布">
...
import {
    ionlineselectByConditionApi,
    ionlineselectCountByConditionApi,
    getEventCodeNameMap
