...
} from '@/api/module/forecastdamagefloor'
import { selectByConditionApi as selectByConditionForelevatorApi } from '@/api/module/projectManage'
import { selectByAllApi, selectByAllTypeApi } from '@/api/module/commont'
import ListComponet from '@/components/singlelist'
import { Elevator_Forecastdamagefloor } from '@/module.ts/Elevator_Forecastdamagefloor'

export default defineComponent({
  components: { ListComponet },
  setup() {
    const modelData = new Elevator_Forecastdamagefloor()
    const typelist = ref([])
    const tableMap = [
      {
