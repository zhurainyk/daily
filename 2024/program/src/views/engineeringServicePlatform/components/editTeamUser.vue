...
export default defineComponent({
  setup() {
    ...
    const disableSuperior = ref(true)
    const disableskillLevel = ref(true)
    ...
    if (store.state.user.userInfo?.db_isSrc == '01') {
      dialogModel.value.db_skillLevel = '01'
    } else if (
      ...
      disableSuperior.value = false
      disableskillLevel.value = false
