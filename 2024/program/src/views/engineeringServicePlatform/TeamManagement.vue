<template>
  <UserManage
    ...
    @edit-fn="editFn"
    @new-fn="newFn"
    :templeteApi="enginUserTemlepteApi"
...
import UserManage from '../dataManagement/organization/UserManagement'
      ...
      $router.push({
        name:
          $route.meta.posiId == '1516732642610339840'
            ? menulist.TeamUserEngEdit.name
            : menulist.TeamUserEdit.name,
        params: {
          id: args.db_id,
          action: 'edit'
        },
