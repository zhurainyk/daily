<template>
    <div class="page-list">
        <ListComponet :select-by-condition-api="clearupselectByConditionApi"
            :select-count-by-condition-api="clearupselectCountByConditionApi" :select-by-id-api="clearupselectByIdApi"
            :save-api="clearupsaveApi" :delete-by-id-api="clearupdeleteByIdApi" :model-data="modelData"
            :table-map="tableMap" :add-model-prop="addModelProp" :search-where-model-prop="searchWhereModelProp"
            :show-new-porp="true" :pagesizes="[100, 200, 300, 400]" :update-by-id-api="clearupupdateByIdApi"
            ...
            :showResetSearch="true" :showActionPorp="true" exportExcelName="" :dialogMount="dialogMount" dbkey="db_id"
            :empty="true">
        </ListComponet>
    </div>
</template>
...
import {
    clearupselectByConditionApi,
    clearupselectCountByConditionApi, clearupupdateByIdApi, clearupselectByIdApi, clearupsaveApi, clearupdeleteByIdApi
...
onMounted(() => {
    ...
    selectByConditionApi({ "db_templateTypeCode": "CleanUpkeep", "ui_type": "A0" }).then(x => {
