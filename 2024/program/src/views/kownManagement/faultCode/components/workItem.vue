...
import {
  ...
  deleteByIdApi,
  selectByIdApi
} from '@/api/module/controleventcodeworkitem'
import { selectByAllApi, selectByAllTypeApi } from '@/api/module/commont'
import ListComponet from '@/components/singlelist'
import { Elevator_ControlWorkItem } from '@/module.ts/Elevator_ControlWorkItem'
...
export default defineComponent({
  ...
  setup(props, contx) {
    const modelData = new Elevator_ControlWorkItem()
