...
import { Usercenter_OpMaintUser } from '@/module.ts/Usercenter_OpMaintUser'
...
export default defineComponent({
  ...
  setup() {
    const modelData = new Usercenter_OpMaintUser()
    const tableMap = [
      {
        dbkey: 'ui_username',
        name: '姓名'
