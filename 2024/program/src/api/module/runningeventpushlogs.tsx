...
export const saveApi = async (arg, file?: any) => {
  return api(
    apiConfig.url,
    '/elevator/irunningEventPushLogs/save',
    'post',
    arg,
    null,
    true,
...
export const updateByIdApi = async (arg, file?: any) => {
  return api(
    apiConfig.url,
    '/elevator/irunningEventPushLogs/updateById',
    'post',
    arg,
    null,
    true,
...
export const deleteByIdApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/irunningEventPushLogs/deleteById',
    'post',
    arg,
    null,
    false
...
export const selectByIdApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/irunningEventPushLogs/selectById',
    'post',
    arg,
    null,
    false
...
export const deleteListApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/irunningEventPushLogs/deleteList',
    'post',
    arg,
    null,
    false
...
export const selectByConditionApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/irunningEventPushLogs/selectByCondition',
    'post',
    arg
  )
}
...
export const selectCountByConditionApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/irunningEventPushLogs/selectCountByCondition',
    'post',
    arg
  )
}
