...
export const updateByIdApi = async (arg, file?: any) => {
  return api(
    apiConfig.url,
    '/elevator/iappearance/updateById',
    'post',
    arg,
    null,
    true,
...
export const deleteByIdApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/iappearance/deleteById',
    'post',
    arg,
    null,
    false
...
export const selectByIdApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/iappearance/selectById',
    'post',
    arg,
    null,
    false
...
export const deleteListApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/iappearance/deleteList',
    'post',
    arg,
    null,
    false
...
export const selectByConditionApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/iappearance/selectByCondition',
    'post',
    arg
  )
}
...
export const selectCountByConditionApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/iappearance/selectCountByCondition',
    'post',
    arg
  )
}
