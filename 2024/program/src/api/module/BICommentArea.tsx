...
export const deleteByIdApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/ibiCommentArea/deleteById',
    'post',
    arg,
    null,
    false
...
export const deleteListApi = async arg => {
  return api(apiConfig.url, '/elevator/ibiCommentArea/deleteList', 'post', arg)
}
export const selectByConditionApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/ibiCommentArea/selectByCondition',
    'post',
    arg
  )
}
...
export const selectCountByConditionApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/ibiCommentArea/selectCountByCondition',
    'post',
    arg
  )
}
