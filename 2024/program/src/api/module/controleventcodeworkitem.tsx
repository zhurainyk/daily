...
export const selectByConditionApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/iworkItem/selectByCondition',
    'post',
    arg
  )
}
...
export const selectCountByConditionApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/iworkItem/selectCountByCondition',
    'post',
    arg
  )
}
