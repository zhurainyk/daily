...
export const updateByIdApi = async (arg, file?: any) => {
  return api(
    apiConfig.url,
    '/elevator/imaintUploadLog/updateById',
    'post',
    arg,
    null,
    true,
...
export const deleteByIdApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/imaintUploadLog/deleteById',
    'post',
    arg,
    null,
    false
...
export const selectByIdApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/imaintUploadLog/selectById',
    'post',
    arg,
    null,
    false
...
export const deleteListApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/imaintUploadLog/deleteList',
    'post',
    arg,
    null,
    false
...
export const selectByConditionApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/imaintUploadLog/selectByCondition',
    'post',
    arg
  )
}
...
export const selectCountByConditionApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/imaintUploadLog/selectCountByCondition',
    'post',
    arg
  )
}
