...
export const deleteListApi = async arg => {
  return api(apiConfig.url, '/elevator/ifeedback/deleteList', 'post', arg)
}
export const selectByConditionApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/ifeedback/selectByCondition',
    'post',
    arg
  )
}
...
export const selectCountByConditionApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/ifeedback/selectCountByCondition',
    'post',
    arg
  )
}
