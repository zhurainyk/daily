...
export const saveApi = async (arg, file?: any) => {
  return api(
    apiConfig.url,
    '/elevator_schedule/ipreAnalysis/save',
    'post',
    arg,
    null,
    true,
...
export const updateByIdApi = async (arg, file?: any) => {
  return api(
    apiConfig.url,
    '/elevator_schedule/ipreAnalysis/updateById',
    'post',
    arg,
    null,
    true,
...
export const deleteByIdApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/ipreAnalysis/deleteById',
    'post',
    arg,
    null,
    false
...
export const selectByIdApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/ipreAnalysis/selectById',
    'post',
    arg,
    null,
    false
...
export const deleteListApi = async arg => {
  return api(apiConfig.url, '/elevator/ipreAnalysis/deleteList', 'post', arg)
}
export const selectByConditionApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/ipreAnalysis/selectByCondition',
    'post',
    arg
  )
}
...
export const selectCountByConditionApi = async arg => {
  return api(
    apiConfig.url,
    '/elevator/ipreAnalysis/selectCountByCondition',
    'post',
    arg
  )
}
