declare interface IElevator_Feedback {
  db_id: string
  ...
  db_updateTime: string // 最后更新时间
  db_content: string // 描述内容
  db_contentFileUrl: string // 文件url
  db_contentFileName: string // 文件名
  db_comments: string // 评论json,{人，时间，文字内容，图片地址}
  ...
  ui_start_updateTime: string // 最后更新时间开始
  ui_end_updateTime: string // 最后更新时间结束
}
